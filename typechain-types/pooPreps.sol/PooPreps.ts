...
export interface PooPrepsInterface extends utils.Interface {
  functions: {
    ...
    "getMaxCumulativeBalanceForAccount(address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "decreaseAllowance"
      | "getController"
      | "getMaxCumulativeBalanceForAccount"
      | "getRouterAddress"
      | "increaseAllowance"
      | "name"
  ...
  encodeFunctionData(
    functionFragment: "getMaxCumulativeBalanceForAccount",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface PooPreps extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PooPrepsInterface;
